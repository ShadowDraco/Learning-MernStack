...
// get the home page
app.get('/', (req, res) => {
    res.render('index', { motd: "Today is the first day of launch!", pageTitle: "Welcome to Praise Adonai!"})
})
...
app.get('/music', (req, res) => {
    res.render('music', { motd: "We sing holy holy holy!", pageTitle: "Find good music!"})
})
app.get('/faith', (req, res) => {
    res.render('faith', { motd: "Faith the size of a mustard seed!", pageTitle: "Learn about The Faith!"})
})
